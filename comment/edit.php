...
try {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "UPDATE comments SET content = :content, date = :date, customer_id = :customer_id, product_id = :product_id WHERE id = :id";
    ...
    <div class="container">
        ...
        <label for="type">ID User : </label>
            ...
            <select class="form-control" name="product_id" id="">
                ...
                ?>
                    <option value="<?php echo $val['product_id'] ?>"selected><?php echo $val['name_product'] ?></option>

                <?php } ?>
            </select>
            <label for="content">Content:</label>
            <input type="text" id="content" name="content" value="<?php echo htmlspecialchars($comment['content']); ?>" required>
            <label for="date">Date:</label>
            <input type="date" id="date" name="date" value="<?php echo htmlspecialchars($comment['date']); ?>"  required>
