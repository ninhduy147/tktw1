...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $sql = "INSERT INTO orders (name, order_date, customer_id,status_id,phone_number,address,total_amount) VALUES (:name, :order_date,:customer_id,:status_id,:phone_number,:address,:total_amount)";
